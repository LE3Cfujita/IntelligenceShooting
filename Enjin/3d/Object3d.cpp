...
XMFLOAT3 Object3d::eye = { -0, 3.0f, -25.0f };
XMFLOAT3 Object3d::target = { 0, 3, 0 };
...
void Object3d::SetUp(XMFLOAT3 up)
{
	Object3d::up = up;
	UpdateViewMatrix();
}
...
void Object3d::MatProjection(int window_width, int window_height)
{
